...
public class CreateWorkStreamCommandHandler(IWorkStreamRepository workStreamRepository) : IRequestHandler<CreateWorkStreamCommand, Core.Models.WorkStream>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await workStreamRepository.CreateAsync(workStream, cancellationToken);
    }
}